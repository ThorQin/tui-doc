var downloadMenu = [
	{ link: 'https://github.com/ThorQin/tui/raw/master/build/tui-1.0-src.zip', value: '下载工程源码' },
	{ link: 'https://github.com/ThorQin/tui/raw/master/build/tui-1.0.zip', value: '下载开发包', icon:'fa-download' }];
