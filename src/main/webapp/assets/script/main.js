var downloadMenu = [
	{ link: 'https://github.com/ThorQin/tui/archive/v1.0.4.zip', value: '下载工程源码' },
	{ link: 'https://github.com/ThorQin/tui/releases/download/v1.0.4/tui-1.0.4.zip', value: '下载开发包', icon:'fa-download' }];
